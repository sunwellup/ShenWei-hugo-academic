...
<DIV align="justify"> 
  ...
  \eqno(1)
  \end{equation}
where in Eq.(1) <i>$\boldsymbol\sigma$</i> and <i>$\boldsymbol\epsilon$</i> are the stress and strain tensors, respectively, and <i>$boldsymbol{v}$</i> is the test function which belongs to the local virtual element space (or say, local shape function space) $ V(K)\timesV(K) $; 
